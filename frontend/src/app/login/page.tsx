    ...
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '24px' }}>
      ...
      >
        ...
        <div className="card" style={{ padding: '32px' }}>
          ...
          <p style={{ color: 'var(--text2)', fontSize: '14px', marginBottom: '24px' }}>Sign in to your account</p>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <div>
              ...
              <input
                ...
                style={{ width: '100%', padding: '10px 14px', borderRadius: '10px', border: '1px solid rgba(0,0,0,0.1)', background: 'var(--bg)', fontSize: '14px', outline: 'none' }}
              />
            </div>
            <div>
