      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 lg:p-12 relative z-10 bg-white shadow-[20px_0_60px_rgba(0,0,0,0.02)]">
        ...
        >
          <div className="mb-6">
            ...
            <h1 className="text-[32px] font-black tracking-tighter leading-none text-gray-900 mb-2">Welcome back</h1>
            <p className="text-[14px] text-gray-600 font-medium tracking-tight">Enter your details for your intelligence dashboard.</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex justify-end -mt-1">
              <a href="#" className="text-[12px] font-bold text-gray-500 hover:text-gray-900 transition-colors">Forgot Password?</a>
            </div>

            <button 
              type="submit" disabled={loading}
              className="w-full bg-gray-900 text-white rounded-full py-4 text-[15px] font-bold shadow-[0_12px_24px_-8px_rgba(0,0,0,0.3)] hover:shadow-[0_16px_32px_-8px_rgba(0,0,0,0.4)] hover:-translate-y-0.5 transition-all duration-300 disabled:opacity-70 flex items-center justify-center gap-2"
            >
          ...
          <p className="mt-8 text-center text-[14px] font-medium text-gray-600">
            New here? <Link href="/register" className="text-gray-900 font-black hover:underline underline-offset-4">Create account</Link>
          </p>
        </motion.div>
      </div>
